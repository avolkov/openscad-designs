...
// Extruder cables path
    translate([33+4.5,10,-1]) cylinder(r=2.5, h=17,$fn=30);
    translate([33+4.5,12,9]) cube([5,4,20], center=true);  
...
// Extruder cables path
    translate([33+4.5,10,-1]) cylinder(r=2.5, h=32,$fn=30);
    translate([33+4.5,12,22]) cube([5,4,20], center=true);
